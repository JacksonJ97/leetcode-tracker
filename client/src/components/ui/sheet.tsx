...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/15 transition-opacity duration-200 ease-in-out data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:backdrop-blur-xs",
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 border-border bg-background p-4 text-sm transition-[translate,opacity] duration-200 ease-in-out data-ending-style:opacity-0 data-starting-style:opacity-0",
          ...
          "data-[side=bottom]:inset-x-0 data-[side=bottom]:bottom-0 data-[side=bottom]:max-h-[50dvh] data-[side=bottom]:border-t data-[side=bottom]:data-ending-style:translate-y-full data-[side=bottom]:data-starting-style:translate-y-full",
          className,
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button size="icon-sm" variant="ghost" className="absolute top-3 right-3">
                <XIcon />
